...
return [
    ...
    |---------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes personalizados para los atributos
    | usando la convención "attribute.rule" para nombrar las líneas. Esto
    | facilita especificar un mensaje específico para una regla dada de
    | un atributo.
    |
    */
    ...
    |---------------------------------------------------------------------------
    |
    | Las siguientes líneas son utilizadas para reemplazar el marcador de
    | posición de atributos por algo más amigable para el lector, como
