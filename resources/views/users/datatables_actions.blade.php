{!! Form::open(['route' => ['users.destroy', $id], 'method' => 'delete', 'class' => 'd-inline', 'id' => 'delete-form-' . $id]) !!}
<div class='btn-group'>
    ...
    <div class="dropdown-menu">
        ...
        <button type="button" class="dropdown-item text-danger" data-toggle="modal" data-target="#deleteModal" data-id="{{ $id }}">
...
<script>
    $(document).ready(function() {
        ...
        $('#deleteModal').on('show.bs.modal', function(event) {
            ...
            var formId = '#delete-form-' + userId; // Construir el ID del formulario
