...
<head>
    ...
    <link rel="shortcut icon" href="{{URL::asset('images/unae.jpg')}}" type="image/x-ico">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <p>
                                {{ Auth::user()->name }}
                                <small>Miembro desde {{ Auth::user()->created_at->locale('es')->format('M. Y') }}</small>
                            </p>
        ...
        <footer class="main-footer">
            ...
            <strong>
                &copy; {{ date('Y') }} Desarrollado por: <a href="{{ url('https://github.com/Ricesc/UNAE-SGM') }}">3° Análisis de Sistemas</a>.
            </strong>
